...
export class Bear1720703879258 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "colors" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "hex" character varying NOT NULL, CONSTRAINT "PK_cd1fb70b1a6d730ad8276551e38" PRIMARY KEY ("id"))`)
    }
